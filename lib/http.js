...
var SDKRequestError = require('./errors/SDKRequestError.js');
var SDKInterface    = require('./interface.js');
...
ServiceSDK.prototype = Object.create(SDKInterface.prototype);
ServiceSDK.prototype.constructor = ServiceSDK;
 ...
 * @return {mixed}
 */
ServiceSDK.prototype.use = function(plugin) {
 ...
 * @return {undefined}
 */
ServiceSDK.prototype._setReqData = function(key, value, config, target) {
    target = target || 'data';
 ...
 * @return {Boolean}
 */
ServiceSDK.prototype._hasBodyPayload = function(httpMethod) {
 ...
 * @return {Promise}
 */
ServiceSDK.prototype.$request = function(options) {
    var self = this;
